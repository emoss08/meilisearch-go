	...
	for !in.IsDelim('}') {
		...
		case "results":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v145 map[string]interface{}
					if in.IsNull() {
						in.Skip()
					} else {
						in.Delim('{')
						v145 = make(map[string]interface{})
						for !in.IsDelim('}') {
							key := string(in.String())
							in.WantColon()
							var v146 interface{}
					...
					out.Results = append(out.Results, v145)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo43(out *jwriter.Writer, in DocumentsResult) {
	...
	_ = first
	{
		...
		if in.Results == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v147, v148 := range in.Results {
				if v147 > 0 {
					out.RawByte(',')
				}
				if v148 == nil && (out.Flags&jwriter.NilMapAsEmpty) == 0 {
					out.RawString(`null`)
				} else {
					out.RawByte('{')
					v149First := true
					for v149Name, v149Value := range v148 {
						if v149First {
							v149First = false
						} else {
							out.RawByte(',')
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v150)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "fields":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Fields = append(out.Fields, v153)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo46(in *jlexer.Lexer, out *Details) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rankingRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RankingRules = append(out.RankingRules, v156)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "searchableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SearchableAttributes = append(out.SearchableAttributes, v157)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "displayedAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.DisplayedAttributes = append(out.DisplayedAttributes, v158)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "stopWords":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.StopWords = append(out.StopWords, v159)
					in.WantComma()
				}
				in.Delim(']')
			}
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						for !in.IsDelim(']') {
							...
							v160 = append(v160, v161)
							in.WantComma()
						}
						in.Delim(']')
					}
					(out.Synonyms)[key] = v160
					in.WantComma()
				}
				in.Delim('}')
			}
		case "filterableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FilterableAttributes = append(out.FilterableAttributes, v162)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "sortableAttributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SortableAttributes = append(out.SortableAttributes, v163)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "swaps":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v164 SwapIndexesParams
					(v164).UnmarshalEasyJSON(in)
					out.Swaps = append(out.Swaps, v164)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo46(out *jwriter.Writer, in Details) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if len(in.RankingRules) != 0 {
		...
		{
			out.RawByte('[')
			for v165, v166 := range in.RankingRules {
				if v165 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SearchableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v167, v168 := range in.SearchableAttributes {
				if v167 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.DisplayedAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v169, v170 := range in.DisplayedAttributes {
				if v169 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.StopWords) != 0 {
		...
		{
			out.RawByte('[')
			for v171, v172 := range in.StopWords {
				if v171 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Synonyms) != 0 {
		...
		}
		{
			out.RawByte('{')
			v173First := true
			for v173Name, v173Value := range in.Synonyms {
				if v173First {
					v173First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				if v173Value == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
					out.RawString("null")
				} else {
					out.RawByte('[')
					for v174, v175 := range v173Value {
						if v174 > 0 {
							out.RawByte(',')
						}
	...
	if len(in.FilterableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v176, v177 := range in.FilterableAttributes {
				if v176 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.SortableAttributes) != 0 {
		...
		{
			out.RawByte('[')
			for v178, v179 := range in.SortableAttributes {
				if v178 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo47(in *jlexer.Lexer, out *DeleteTasksQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v183)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v184 TaskStatus
					v184 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v184)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v185 TaskType
					v185 = TaskType(in.String())
					out.Types = append(out.Types, v185)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "CanceledBy":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v186 int64
					v186 = int64(in.Int64())
					out.CanceledBy = append(out.CanceledBy, v186)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo47(out *jwriter.Writer, in DeleteTasksQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v189, v190 := range in.IndexUIDS {
				if v189 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v191, v192 := range in.Statuses {
				if v191 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.CanceledBy == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v195, v196 := range in.CanceledBy {
				if v195 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo48(in *jlexer.Lexer, out *CsvDocumentsQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo48(out *jwriter.Writer, in CsvDocumentsQuery) {
	out.RawByte('{')
	first := true
	_ = first
	if in.PrimaryKey != "" {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo49(in *jlexer.Lexer, out *CreateIndexRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo49(out *jwriter.Writer, in CreateIndexRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UID != "" {
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo50(in *jlexer.Lexer, out *CancelTasksQuery) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "IndexUIDS":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.IndexUIDS = append(out.IndexUIDS, v198)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Statuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v199 TaskStatus
					v199 = TaskStatus(in.String())
					out.Statuses = append(out.Statuses, v199)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "Types":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v200 TaskType
					v200 = TaskType(in.String())
					out.Types = append(out.Types, v200)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo50(out *jwriter.Writer, in CancelTasksQuery) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.IndexUIDS == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v203, v204 := range in.IndexUIDS {
				if v203 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v205, v206 := range in.Statuses {
				if v205 > 0 {
					out.RawByte(',')
				}
